...
import { checkAndShowFillAllButton, closeSuggestionBox, showConfirmationMessage, showFillAllConfirmation } from './uiManager';
 ...
 */
export function getAllFillableInputs(): Array<HTMLInputElement | HTMLTextAreaElement> {
