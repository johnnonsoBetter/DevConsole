...
const COMPANIES: CompanyData[] = [
  ...
  {
    name: "Summit Digital",
    domain: "summitdigital.com",
    industry: "Digital Agency",
  },
  {
    name: "Horizon Innovations",
    domain: "horizoninnovations.co",
    industry: "Innovation",
  },
  {
    name: "Velocity Partners",
    domain: "velocitypartners.com",
    industry: "Consulting",
  },
  {
    name: "Synergy Solutions",
    domain: "synergysolutions.io",
    industry: "Business Solutions",
  },
  {
    name: "Prime Software",
    domain: "primesoftware.dev",
    industry: "Software Development",
  },
  {
    name: "Atlas Global",
    domain: "atlasglobal.com",
 ...
 */
export function generateRelationalPersona(
...
export { COMPANIES, US_LOCATIONS };
export type { CompanyData, LocationData };
