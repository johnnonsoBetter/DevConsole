...
const EDGE_CASE_DATASETS: Dataset[] = [
  ...
  },
  {
    ...
    category: 'edge-cases',
    data: {
      email: 'verylongemailaddressthatmightbreakvalidation1234567890abcdefghijklmnopqrstuvwxyz@verylongdomainnamethatmightcauseissues.com',
      name: 'A'.repeat(500),
      ...
      address: '12345 Very Long Street Name That Goes On And On Boulevard, Apartment 99999, Building Z, Floor 100',
  ...
  },
  {
    ...
    data: {
      ...
      message: 'Test: "quotes", \'apostrophes\', <angles>, {braces}, [brackets]',
...
const I18N_DATASETS: Dataset[] = [
  ...
  },
  {
    ...
    data: {
      ...
      message: 'Vielen Dank für Ihre Nachricht. Ich freue mich auf unsere Zusammenarbeit.',
    },
  },
  {
    id: 'i18n-russian',
...
const ACCESSIBILITY_DATASETS: Dataset[] = [
  {
    ...
    data: {
      ...
      zip: '97201',
      country: 'United States',
      message: 'Hello. I am interested in learning more. Please contact me at your earliest convenience. Thank you.',
      number: 'fifty',
    },
  },
  {
    ...
    data: {
      ...
      number: 'twenty-five',
      message: 'Contact me at five five five, one two three, four five six seven.',
    },
  },
];
...
const SECURITY_DATASETS: Dataset[] = [
  ...
  },
  {
    ...
    data: {
      ...
      firstName: '<%= 7*7 %>',
      lastName: '#{7*7}',
      message: '{{constructor.constructor("return this.process.mainModule.require(\'child_process\').execSync(\'id\')")()}}',
    },
  },
];
 ...
 */
export function getRandomDatasetFromScenario(id: TestScenario): Dataset | undefined {
