/**
 * Summarizer API Card Component
 * Manages its own state using useSummarizerModel hook
 */
...
import { useSummarizerModel } from '../../../hooks/ai/useSummarizerModel';
...
export function SummarizerCard() {
  ...
  const handleActivate = async () => {
    ...
    try {
      ...
      console.error('Failed to activate Summarizer:', error);
    } finally {
