/**
 * Translator API Card Component
 * Manages its own state using useTranslatorModel hook
 */
...
import { useTranslatorModel } from '../../../hooks/ai/useTranslatorModel';
...
export function TranslatorCard() {
  ...
  useEffect(() => {
    // Check default language pair (en -> es)
    checkAvailability('en', 'es');
  }, [checkAvailability]);
